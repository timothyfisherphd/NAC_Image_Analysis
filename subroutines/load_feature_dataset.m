...
% --------------------------------------------------------------------   
 case 'all6',                  switch upper(setVersion)
   case 'PRIMARY'
     setFile = 'PRIMARY/all6_numFeatures80_last_output_rand_57105.mat'; %'PRIMARY/all6_numFeatures80_last_output_rand_48936.mat'; %all6_numFeatures80_last_output_rand_73832.mat';
   case 'MET', 
     setFile = 'MET/';          end     
