...
addpath([pwd,'../full_slide_classifier_code_linux/subroutines'],'-end'); % my own functions, see license
addpath([pwd,'../full_slide_classifier_code_linux/lbp'],'-end'); % code for LBP, see license in subfolder
addpath([pwd,'../full_slide_classifier_code_linux/perceptual'],'-end'); % code for perceptual features, see license in subfolder
